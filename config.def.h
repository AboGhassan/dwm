...
static const char ui_color[4][7]   = {
...
static const char *dmenucmd[] = { "dmenu_run", "-m", dmenumon, "-fn", dmenufont, "-nb", ui_color[1], "-nf", ui_color[3], "-sb", ui_color[0], "-sf", ui_color[4], NULL };
